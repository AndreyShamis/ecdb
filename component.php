...
<body>
    <div id="wrapper">
        ...
        <div id="content">
            ...
            <?php
                echo $executesql_head_catname['id']. '"> '. $executesql_head_catname['name'] . '</a> / ';
                echo '<a href="category.php?subcat=' . $executesql_sub_catname['id'] . '"> '. $executesql_sub_catname['name'];
            ?>
            ...
            <div class="aboutComponentHeader">
                <div class="componentGallery">
                    ...
                    if ($executesql['url1'] == "") {
                        ...
                        echo '<a alt="" href="'. $executesql['url1'] . '" target="_blank"><img src="' . $executesql['url1']. '"/></a>';
                    }
                    ?>
                    </div>
