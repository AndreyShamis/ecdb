...
$executesql         = $db->fetch_array($GetDataComponent);
...
$personal       = $db->fetch_array($GetPersonal);
                                ...
                                <select name="category">
                                    <?php
                                        ...
                                        while ($HeadCategory = $db->fetch_assoc($sql_exec_headcat)) {
                                            echo '<option class="main_category" value="'. $HeadCategory['id'] . '" disabled>'. $HeadCategory['name'] . '</option>';
